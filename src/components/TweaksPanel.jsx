...
export function useTweaks(defaults) {
  const STORAGE_KEY = 'kpdl-tweaks-v3';
...
// ── TweaksPanel ─────────────────────────────────────────────────────────────
// Floating shell. Toggle open/closed with the ⚙ button (bottom-left). In the
// standalone app there is no host frame, so we self-manage the open state.
    ...
    return (
      <button onClick={() => setOpen(true)} aria-label="Open tweaks"
        style={{
          ...
          background: 'rgba(250,249,247,.9)', color: '#29261b', fontSize: 20,
