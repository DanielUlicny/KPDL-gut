// Mock data for KPDL — playful theme
const REGIONS = [
...
// Logbook — logged ascents, newest first
const LOGBOOK = [
...
Object.assign(window, { REGIONS, LOKALITY, SEKTORY, ROUTES_LOM_A, PROJECTS, USER, LOGBOOK, VISITED, BADGES });
